<template>
  <section class="content-container organisers">
    ...
    <div class="socialmedia" style=" text-align: center;">
      ...
      <a href="mailto:hello@cssfrankfurt.de" title="Mail link"><mail-icon class="social-icon" role="img" aria-hidden="true"/></a>
    </div>
    <div class="profile" v-for="profile in profiles" :key="profile.name">
      ...
      <div class="info">
        ...
        <div class="socialmedia">
          <a :href="profile.twitter" v-if="profile.twitter" title="Twitter link"><twitter-icon class="social-icon" role="img" aria-hidden="true"/></a>
          <a :href="profile.github" v-if="profile.github" title="Github link"><github-icon class="social-icon" role="img" aria-hidden="true"/></a>
          <a :href="profile.codepen" v-if="profile.codepen" title="Codepen link"><codepen-icon class="social-icon" role="img" aria-hidden="true"/></a>
          <a :href="profile.linkedin" v-if="profile.linkedin" title="Linkedin link"><linkedin-icon class="social-icon" role="img" aria-hidden="true"/></a>
          <!-- <a :href="profile.youtube" v-if="profile.youtube" title="External website link"><youtube-icon class="social-icon" role="img" aria-hidden="true"/></a> -->
          <a :href="profile.external" v-if="profile.external" title="External website link"><external-link-icon class="social-icon" role="img" aria-hidden="true"/></a>
        </div>
      </div>
    </div>
  </section>
    ...
    profiles: [
      {
        ...
        company: 'melsicon',
        pic: require('@/assets/victoria.gif'),
        quote:
      ...
      },
      {
        ...
        title: 'Front-End Developer',
        company: 'DB Systel',
        pic: require('@/assets/melana.gif'),
        quote:
          'Be bold or italic, but never be regular. Talk to me about hackathons, motorcycles and BI software mashups!',
        twitter: 'https://twitter.com/katradical',
        external: 'https://www.xing.com/profile/Melana_Groenert'
      },
      {
