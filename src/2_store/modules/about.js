const state = {
  about: {
    ...
    organisers: {
      title: 'Organisers',
      content:
        'CSS Frankfurt is currently organised by four friends loyal to Frank. As a thank you, Frank gifted each of them a hoodie with their personal Frank clone printed on the back. If you would like to help organise CSS Frankfurt, there is always help needed, so please reach out to us!',
      profiles: [
        {
          name: 'Melana Grönert',
        ...
        },
        {
          ...
          quote: 'Sharks are just ugly dolphins! CSS all day, every day.',
          socialmedia: {
        ...
        },
        {
          ...
          quote:
            'Star gazing at night, coding during day — and vice versa. If none of the above applies, find me on my bike!',
          socialmedia: {
